	...
	public static void main(String[] args) {
		...
		do {
			...
			if(intento.length()>contraseña.length()) {
				System.out.println("La palabra que has introducido es mayor alfabéticamente. Prueba de nuevo");
			}
			
			if(intento.length()<contraseña.length()) {
				System.out.println("La palabra que has introducido es menor alfabéticamente. Prueba de nuevo");
